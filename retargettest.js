...
test.describe('Difficulty retarget test', () => {
    ...
    test.it('Test retarget other branches', function (done) {
        ...
        let block = new BC.Block(BC.ROOT_HASH, '104566', '0', 'x');
        ...
        block = new BC.Block('0000775a57e301f40a233af9e38a5b4b88252990e54ff6d5cdd90193bae574ab', '4666', '10', 'x');
        block.blockHash = '0000946104f7553285a916a1b4fcfa5daa90d3bfdba15f06f5f48f85dc8f508c';
        result = blockchain.addBlock(block, false);
        assert.equal(result.valid, true);

        block = new BC.Block('0000946104f7553285a916a1b4fcfa5daa90d3bfdba15f06f5f48f85dc8f508c', '24846', '2000000', 'x');
        ...
        block = new BC.Block('00002210f887de78b5697862f9b04a9ad880afc81a23a012b75b000a2c1305cd', '57500', '2000010', 'x');
        block.blockHash = '00012eb9a9a568a13af7bad824ecf9719238aa45093d991941ed64a35e12fdd7';
        result = blockchain.addBlock(block, false);
        assert.equal(result.valid, true);

        block = new BC.Block('0000946104f7553285a916a1b4fcfa5daa90d3bfdba15f06f5f48f85dc8f508c', '57504', '500000', 'x');
        ...
        block = new BC.Block('000093b3cea80d91e5046abe34a750c690891afa47ac83edba838e52190ec312', '147774', '500010', 'x');
        block.blockHash = '00009a0db70081b2091775b23c4f2829b5d9515c798d77533c99aef599565995';
        result = blockchain.addBlock(block, false);
        assert.equal(result.valid, false);

        block = new BC.Block('000093b3cea80d91e5046abe34a750c690891afa47ac83edba838e52190ec312', '211319', '500010', 'x');
        block.blockHash = '000048021b2f9e47e0c81783ce2940cc318f31d909bf537526e73fb54a9fb013';
        result = blockchain.addBlock(block, false);
        assert.equal(result.valid, true);

        block = new BC.Block('000048021b2f9e47e0c81783ce2940cc318f31d909bf537526e73fb54a9fb013', '526528', '750000', 'x');
        ...
        block = new BC.Block('00002007422630a845f547083b9bad6ffd06bb4653cfc575f0f6bbf7038bf4bc', '201327', '750010', 'x');
        block.blockHash = '00002d44ede421cb9287e478999fd875ea84247b430d140d680d203a99854897';
        result = blockchain.addBlock(block, false);
        assert.equal(result.valid, false);
        assert.equal(blockchain.topBlockHash, 'e');

        block = new BC.Block('00002007422630a845f547083b9bad6ffd06bb4653cfc575f0f6bbf7038bf4bc', '243011', '750010', 'x');
    ...
    let createBlock = (_blockHash, _prevBlockHash, _ts) => {
        let block = new BC.Block(_prevBlockHash, 1, _ts, 'x');
